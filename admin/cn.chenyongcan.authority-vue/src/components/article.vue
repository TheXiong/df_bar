            ...
            <el-tab-pane label="内容管理">
              ...
              <template>
                <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" highlight-current-row style="width: 100%;"
                  ...
                  <el-table-column prop='comeFrom' label='来源' width='180'></el-table-column>
                  <el-table-column prop='comeFromLink' label='来源链接' width='180'></el-table-column>
              ...
              <el-dialog title='新增' :visible.sync='dialogAddVisible' width='90%' :before-close='handleClose'>
                <el-form :model='addForm' label-width='80px' :rules='addFormRules' ref='addForm'>
                  ...
                  <el-form-item label='来源' prop="comeFrom">
                    <el-input v-model='addForm.comeFrom' auto-complete='off'></el-input>
                  </el-form-item>
                  <el-form-item label='来源链接' prop="comeFromLink">
                    <el-input v-model='addForm.comeFromLink' auto-complete='off'></el-input>
                  </el-form-item>
                  <el-form-item label='内容' prop="contents">
                    <el-input v-model='addForm.contents' auto-complete='off'></el-input>
                  </el-form-item>
                </el-form>
              ...
              <el-dialog title='修改' :visible.sync='dialogEditVisible' width='90%' :before-close='handleClose'>
                <el-form :model='editForm' label-width='80px' :rules='editFormRules' ref='editForm'>
                  ...
                  <el-form-item label='来源' prop="comeFrom">
                    <el-input v-model='editForm.comeFrom' auto-complete='off'></el-input>
                  </el-form-item>
                  <el-form-item label='来源链接' prop="comeFromLink">
                    <el-input v-model='editForm.comeFromLink' auto-complete='off'></el-input>
                  </el-form-item>
                  <el-form-item label='内容' prop="contents">
  ...
  export default {
    ...
    methods: {
      ...
      handleSearch: function() {
        ...
        self.$axios.post('/BaseAritlce/ListByPage?page=' + self.searchForm.page + "&limit=" + self.searchForm.limit,
      ...
      handleSave: function(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$axios.post('/BaseAritlce/Create', this.addForm).then((res) => {
      ...
      handleUpdate: function(formName) {
        let self = this;
        this.$axios.post('/BaseAritlce/Edit', this.editForm).then((res) => {
          self.$message.success(res.data.msg);
          self.handleSearch();
      ...
      handleAuditStatus: function(index, row) {
        let self = this;
        this.$axios.post('/BaseAritlce/Audit/'+row.id).then((res) => {
          if (res.data.code == 200) {
            self.$message.success(res.data.msg);
            self.handleSearch();
          } else {
      ...
      handleDel: function() {
        ...
        this.$confirm('确认删除该记录吗?', '提示', {
          ...
          self.$axios.post('/BaseAritlce/SetDeleted', qs.stringify({
            'ids': ids
          }, {
            indices: false
      ...
      handleSingleDelete(index, row) {
        ...
        self.$confirm('确认删除该记录吗?', '提示', {
          ...
          axios.post('/BaseAritlce/SetDeleted', qs.stringify(para))
            .then(function(response) {
              self.$message.success(response.data.msg);
              self.handleSearch();
            })
