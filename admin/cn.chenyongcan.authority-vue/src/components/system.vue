            ...
            <el-tab-pane label="子系统管理">
              ...
              <template>
                <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" highlight-current-row style="width: 100%;"
                  ...
                  <el-table-column prop='title' label='系统名称' width='180'></el-table-column>
              ...
              <el-dialog title='修改' :visible.sync='dialogEditVisible' width='50%' :before-close='handleClose'>
                <el-form :model='editForm' label-width='80px' :rules='editFormRules' ref='editForm'>
                  <el-form-item label='系统编码' prop="code">
                    <el-input v-model='editForm.code' auto-complete='off' readonly="true"></el-input>
                  </el-form-item>
                  <el-form-item label='系统名称' prop="title">
  ...
  export default {
    ...
    methods: {
      ...
      handleSearch: function() {
        ...
        self.$axios.post('/BaseSystem/ListByPage?page=' + self.searchForm.page + "&limit=" + self.searchForm.limits,
      ...
      handleSave: function(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$axios.post('/BaseSystem/Create', this.addForm).then((res) => {
      ...
      handleUpdate: function(formName) {
        let self = this;
        this.$axios.post('/BaseSystem/Edit', this.editForm).then((res) => {
          self.$message.success(res.data.msg);
          self.handleSearch();
      ...
      handleDel: function() {
        ...
        this.$confirm('确认删除该记录吗?', '提示', {
          ...
          self.$axios.post('/BaseSystem/SetDeleted', qs.stringify({
            'ids': ids
          }, {
            indices: false
      ...
      handleSingleDelete(index, row) {
        ...
        self.$confirm('确认删除该记录吗?', '提示', {
          ...
          axios.post('/BaseSystem/SetDeleted', qs.stringify(para))
            .then(function(response) {
              self.$message.success(response.data.msg);
              self.handleSearch();
            })
