      ...
      <el-col :span='24'>
        <div class='bg-white h-100 mx-1 p-1 shadowed'>
          <el-tabs type="border-card">
            <el-tab-pane label="接口密钥">
              <el-form :model="searchForm" ref="searchForm">
                <el-row>
                  <el-col :span="6">
                    <div class="demo-input-suffix">
                      <el-input v-model="searchForm.appkey" placeholder="请输入内容">
            ...
            <el-tab-pane label="接口密钥">
              ...
              <template>
                <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" highlight-current-row style="width: 100%;"
                  ...
                  <el-table-column prop='appkey' label='编码' width='180'></el-table-column>
                  <el-table-column prop='appsecurity' label='名称' width='180'></el-table-column>
              ...
              <el-dialog title='新增' :visible.sync='dialogAddVisible' width='50%' :before-close='handleClose'>
                <el-form :model='addForm' label-width='80px' :rules='addFormRules' ref='addForm'>
                  ...
                  <el-form-item label='编码' prop="appkey">
                    <el-input v-model='addForm.appkey' auto-complete='off'></el-input>
                  </el-form-item>
                  <el-form-item label='名称' prop="appsecurity">
                    <el-input v-model='addForm.appsecurity' auto-complete='off'></el-input>
                  </el-form-item>
              ...
              <el-dialog title='修改' :visible.sync='dialogEditVisible' width='50%' :before-close='handleClose'>
                <el-form :model='editForm' label-width='80px' :rules='editFormRules' ref='editForm'>
                  ...
                  <el-form-item label='名称' prop="appsecurity">
                    <el-input v-model='editForm.appsecurity' auto-complete='off'></el-input>
                  </el-form-item>
                  <el-form-item label='排序' prop="sortCode">
  ...
  export default {
    ...
    methods: {
      ...
      handleSearch: function() {
        ...
        self.$axios.post('/BaseApiSecurity/ListByPage?page=' + self.searchForm.page + "&limit=" + self.searchForm.limits,
      ...
      handleSave: function(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$axios.post('/BaseApiSecurity/Create', this.addForm).then((res) => {
      ...
      handleUpdate: function(formName) {
        let self = this;
        this.$axios.post('/BaseApiSecurity/Edit', this.editForm).then((res) => {
          self.$message.success(res.data.msg);
          self.handleSearch();
      ...
      handleDel: function() {
        ...
        this.$confirm('确认删除该记录吗?', '提示', {
          ...
          self.$axios.post('/BaseApiSecurity/SetDeleted', qs.stringify({
            'ids': ids
          }, {
            indices: false
      ...
      handleSingleDelete(index, row) {
        ...
        self.$confirm('确认删除该记录吗?', '提示', {
          ...
          axios.post('/BaseApiSecurity/SetDeleted', qs.stringify(para))
            .then(function(response) {
              self.$message.success(response.data.msg);
              self.handleSearch();
            })
      ...
      handleExport: function() {
        axios.post('/BaseApiSecurity/export')
          .then(function(response) {
            self.$message.success(response.data.msg);
            self.handleSearch();
          })
